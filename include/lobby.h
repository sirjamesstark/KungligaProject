...
int runningLobby(SDL_Renderer *pRenderer, SDL_Rect *pScreenRect, bool *pMenuRunning, bool *pStartGame,
                 Audio *pAudio, Background *pBackground, Cursor *pCursor);
void handleMouseInLobby(SDL_Event *pEvent, Button *pButtons[], bool *pMenuRunning,
                        bool *pStartGame, Audio *pAudio, bool *pLobbyRunning, Cursor *pCursor);
