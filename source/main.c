...
int main(int argv, char **args)
{
    ...
    while (!closeWindow)
    {
        ...
        if (shipY < 0)
            shipY = 0;
        if (shipX > DM.window_width - shipRect.w)
            shipX = DM.window_width - shipRect.w;
        if (shipY > DM.window_height - shipRect.h)
            shipY = DM.window_height - shipRect.h;
        shipRect.x = shipX;
        shipRect.y = shipY;
...
int main(int argv, char** args) {
    ...
    SDL_Quit();
    return 0;
>>>>>>> 00fdd3aa3811aee288e74ac5652a14e33c877220
}